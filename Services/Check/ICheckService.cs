...
namespace Services
{
    public interface ICheckService
    {
        ...
        public Task<List<StationLoopCheckData>> GetStationLoopCheckReport(string reportCategory, string brandName, int equipmentID, DateTime startDateTime, DateTime endDateTime);
    }
}
