            ...
            try
            {
                ...
                var productionReport = (from report in _context.HistoricalProductionDailyReports
                                        ...
                                        select new ProductionReport
                                        {
                                            ...
                                            StandardPreHou = sdcdt.BrandName == "Turbo" ? "N/A" : report.StandardPreHou == null ? null : Convert.ToDouble(report.StandardPreHou).ToString("f2"),
                                            StandardPreDay = sdcdt.BrandName == "Turbo" ? "N/A" : report.StandardPreDay == null ? null : Convert.ToDouble(report.StandardPreDay).ToString("f2"),
